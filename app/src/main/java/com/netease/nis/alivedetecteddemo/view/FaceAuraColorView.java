...
public class FaceAuraColorView extends View {
    ...
    public static final float HEIGHT_OFFSET_RATIO = 0.10f;
    ...
    private static final int DEFAULT_DIFFUSE_SPEED = 80;
    // 圆形扩散速度
    private int mDiffuseSpeed = DEFAULT_DIFFUSE_SPEED;
    // 背景透明度
    ...
    private final Paint mDiffusePaint;

    private final Paint mBGPaint;
    private final Paint mFaceRoundPaint;

    private Rect mFaceRect;
    private final Paint mTextSecondPaint;
    private final Paint mTextTopPaint;
    ...
    public FaceAuraColorView(Context context, AttributeSet attrs) {
        ...
        mTextSecondPaint.setTextSize(Util.INSTANCE.dip2px(getContext(), 16));
        ...
        mTextTopPaint.setTextSize(Util.INSTANCE.dip2px(getContext(), 22));
        ...
        Paint mCircleBorderPaint1 = new Paint(Paint.ANTI_ALIAS_FLAG);
        ...
        Paint mCircleBorderPaint2 = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        float y = canvasHeight / 2 - canvasHeight / 2 * HEIGHT_OFFSET_RATIO;
    ...
    public void start(int color) {
        ...
        mWidths.add(0);
        alphaBackground = 255;
        mDiffuseSpeed = DEFAULT_DIFFUSE_SPEED;
